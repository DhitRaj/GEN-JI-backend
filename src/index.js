...
mongoose.connect(process.env.MONGODB_URI || process.env.MONGODB_LOCAL)
  .then(async () => {
    ...
    try {
        ...
        const servicesData = [
          {
            ...
            icon: '🌐',
            features: ['Next.js & React', 'Responsive Design', 'SEO Optimized', 'Fast Performance', 'Progressive Web Apps', 'API Integration'],
          ...
          },
          {
            ...
            icon: '📱',
            features: ['React Native', 'Flutter', 'Native Development', 'App Store Ready', 'Push Notifications', 'Offline Support'],
          ...
          },
          {
            ...
            icon: '⚙️',
            features: ['User Management', 'Subscription System', 'Analytics Dashboard', 'API Integration', 'Payment Gateway', 'Multi-tenant Architecture'],
          ...
          },
          {
            ...
            icon: '🛒',
            features: ['Payment Gateway', 'Inventory System', 'Admin Dashboard', 'Order Management', 'Customer Portal', 'Analytics & Reports'],
          ...
          },
          {
            ...
            icon: '🤖',
            features: ['AI Chatbots', 'Process Automation', 'ML Models', 'Data Analysis', 'Natural Language Processing', 'Computer Vision'],
          ...
          },
          {
            ...
            icon: '🔧',
            features: ['Full Stack Development', 'Microservices', 'Cloud Native', 'Enterprise Ready', 'Scalable Architecture', 'DevOps Integration'],
            price: 'Custom Quote',
            order: 6
          }
        ];
      ...
      console.error('❌ Services seed error:', err.message);
    }
